...
setwd("/scratch/mjb51923/Ab10_Global_Survey/out/WorldClim2/ClimateData/SSP370")
dir <- "/scratch/mjb51923/Ab10_Global_Survey/out/WorldClim2/ClimateData/SSP370/original"
outdir <- "/scratch/mjb51923/Ab10_Global_Survey/out/WorldClim2/ClimateData/SSP370/asc"
...
writeRaster(ra, paste(outdir, "/", file, ".asc", sep=""), format="ascii")
