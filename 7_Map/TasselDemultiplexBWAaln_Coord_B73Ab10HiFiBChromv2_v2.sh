...
#SBATCH -J TasselDemultiplexBWAaln_Coord_B73Ab10HiFiBChromv2_v2
#SBATCH --output TasselDemultiplexBWAaln_Coord_B73Ab10HiFiBChromv2_v2.out
#SBATCH --mem=900GB
...
KEY="/scratch/mjb51923/Ab10_Global_Survey/out/AlignGBS_HiFiAb10Corrected_v2/SwartsAllControlsLengthFiltRomeroNavarroRomay_Key_CordSNP.txt"
REF="/scratch/mjb51923/ref_genomes/Ab10_HiFi_v2_corrected_BChrom.noscaf.fa"
NAME="CoordinateOnly_Ab10BChrom"
...
run_pipeline.pl -Xms200G -Xmx850G -fork1 -SAMToGBSdbPlugin -i $OUT_DIR/"BWAaln_"$NAME"_v_"$REF_NAME".sam" -db $OUT_DIR/$NAME".db" -aProp 0.0 -aLen 0 -endPlugin -runfork1
