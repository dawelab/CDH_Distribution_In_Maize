...
#SBATCH -J Submit_Filter_MaxEntAscFiles.sh
#SBATCH --output Submit_Filter_MaxEntAscFiles.%A-%a.out
#SBATCH --mem=50GB
#SBATCH --time=1:00:00
#SBATCH	--nodes=1
#SBATCH	--ntasks=1
...
Rscript --vanilla /scratch/mjb51923/Ab10_Global_Survey/Ab10-Global-Survey/7_Map/Filter_MaxEntAscFiles.R ${DIR[$IT]} ${TYPE[$IT]} ${MODEL[$IT]}