...
#SBATCH -J Submit_Area_HighChangeAreaBelow.sh
#SBATCH --output Submit_Area_HighChangeAreaBelow.%A-%a.out
#SBATCH --mem=75GB
#SBATCH --time=1:00:00
#SBATCH	--nodes=1
#SBATCH	--ntasks=1
...
Rscript --vanilla /scratch/mjb51923/Ab10_Global_Survey/Ab10-Global-Survey/7_Map/Area_HighChangeAreaBelow.R ${DIR[$IT]} ${TYPE[$IT]} ${MODEL[$IT]}