...
MISS <- read.table("Tassel_TagTaxaDist_AllData_v5_v_B73-Ab10_BChrom.Sub1Perc.Missing.txt", header = TRUE)
...
write.csv(DF, file="Tassel_TagTaxaDist_AllData_v2_v_B73-Ab10_BChrom.Sub1Perc.MissingAll.txt", row.names = FALSE, quote = FALSE)
