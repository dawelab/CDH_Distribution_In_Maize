#!/bin/bash
#SBATCH --job-name=Join_Missing_1Perc_K10L2
#SBATCH --output Join_Missing_1Perc_K10L2.out
...
DIRNAME="AlignGBS_K10L2Contigs"
TAXA="Tassel_TagTaxaDist_AllData_v7_v_K10L2Contigs"
