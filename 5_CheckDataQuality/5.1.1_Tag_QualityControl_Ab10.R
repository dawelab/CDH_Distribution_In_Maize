...
NUM_TAG <- apply(MERGE_Ab10Hap_RPM[,-c(1:6)], 2, function(x) sum( x != 0))
...
NUM_TAG_FILT <- apply(MERGE_Ab10Hap_RPM_FILT[,-c(1:6)], 2, function(x) sum( x != 0))
...
png(filename = "Ab10_PercentTagsFilteredForMAPQByAb10Status.png", height = 1100, width = 500)
