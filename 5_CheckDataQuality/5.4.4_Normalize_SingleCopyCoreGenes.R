...
print("######## Finished loading files and merging")
...
print("######## Finished selecting control only tags")
...
print("######## Finished loading the sum data")
...
colnames(MERGE_TAGSFilt_Norm) <- COLNAME

fwrite(MERGE_TAGSFilt_Norm, file=paste("SingleCopyCoreGeneChunks/", NAME,"_temp2_", IT, ".RPM" ,".bed", sep=""), quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
