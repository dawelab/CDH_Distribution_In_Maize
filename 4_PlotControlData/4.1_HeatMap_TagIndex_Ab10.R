...
colors <- list(`Chr10 Type` = c("Ab10-I" = "black","Ab10-II" = "grey25","Ab10-III" =  "grey40", "N10" ="grey90"), Feature = c('TR1' = "#56B4E9", 'trkin' = "#0072B2", 'Shared region' = "#E69F00", 'knob 180' = "#D55E00", 'kindr' = "#CC79A7", 'kin10-like' =  "#009E73", " " = "white" ))

pdf("HeatMap_B73Ab10v2_TagIndexMinMax_Ab10.pdf", height = 5, width = 5)
...
pdf("HeatMap_B73Ab10v2_TagIndexMinMax_Ab10_ColNames.pdf", height = 5, width = 5)
...
pdf("HeatMap_B73Ab10v2_TagIndexMinMax_Ab10_ColClust.pdf", height = 5, width = 5)
...
pdf("HeatMap_B73Ab10v2_TagIndexMinMax_Ab10_ColClust_ColNames.pdf", height = 5, width = 10)
...
pdf("HeatMap_B73Ab10v2_TagIndexMinMax_Ab10_ColClust_RowClust.pdf", height = 5, width = 10)
...
pdf("HeatMap_B73Ab10v2_TagIndexMinMax_Ab10_ColClust_RowClust_RowNames.pdf", height = 5, width = 10)
