...
#SBATCH -J Submit_SubtractMaize.sh
#SBATCH --output Submit_SubtractMaize.%A-%a.out
#SBATCH --mem=50GB
#SBATCH --time=2:00:00
#SBATCH	--nodes=1
#SBATCH	--ntasks=1
...
Rscript --vanilla /scratch/mjb51923/Ab10_Global_Survey/Ab10-Global-Survey/7_Map/SubtractMaize.R ${DIR[$IT]} ${TYPE[$IT]} ${MODEL[$IT]}