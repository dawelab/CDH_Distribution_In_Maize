...
#SBATCH -J Submit_ID_HighChangeArea.sh
#SBATCH --output Submit_ID_HighChangeArea.%A-%a.out
#SBATCH --mem=75GB
#SBATCH --time=1:00:00
#SBATCH	--nodes=1
#SBATCH	--ntasks=1
...
Rscript --vanilla /scratch/mjb51923/Ab10_Global_Survey/Ab10-Global-Survey/7_Map/ID_HighChangeArea.R ${DIR[$IT]} ${TYPE[$IT]} ${MODEL[$IT]}