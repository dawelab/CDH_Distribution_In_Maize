...
#SBATCH -J TasselDemultiplexBWAaln_SGEData_B73Ab10HiFiBChromv2_v2
#SBATCH --output TasselDemultiplexBWAaln_SGEData_B73Ab10HiFiBChromv2_v2.out
#SBATCH --mem=600GB
