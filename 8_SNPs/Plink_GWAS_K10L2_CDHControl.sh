...
#SBATCH -J Plink_GWAS_K10L2_CDHControl
#SBATCH --output Plink_GWAS_K10L2_CDHControl.out
#SBATCH --mem=50GB
#SBATCH --time=2:00:00
#SBATCH	--nodes=1
#SBATCH	--ntasks=1
...
NAME="GWAS_Mo17_K10L2.K10L2.landrace.filt.imputed"
...
plink --bfile $DIR/$NAME --logistic --beta -covar $DIR/K10L2_PCA.eigenvec --pheno $DIR/K10L2Call_ForPLINK.txt --1 --allow-no-sex --allow-extra-chr --out K10L2_K10L2_PCA_results
