...
ORTHO <- read.delim("/scratch/mjb51923/Ab10_Global_Survey/out/OrthoFinder/Mo17_K10L2_proteomes/OrthoFinder/Results_Feb14/Orthologues/Orthologues_Zm-Mo17-REFERENCE-CAU-2.0_Zm00014ba.protein.Longest/Zm-Mo17-REFERENCE-CAU-2.0_Zm00014ba.protein.Longest__v__CI66_K10L2.v2.protein.longest.tsv")
...
ORTHO_MELT_temp2 <- cSplit(ORTHO_MELT_temp1, "CI66_K10L2.v2.protein.longest", sep = ",", direction = "long")
...
ORTHO_MELT_temp4 <- separate(ORTHO_MELT_temp3, col = `CI66_K10L2.v2.protein.longest` , into = c("Ab10_ID", "Ab10_Iso"))
...
write.table(DATA, "/scratch/mjb51923/Ab10_Global_Survey/out/OrthoFinder/Mo17_K10L2_proteomes/Mo17GenesOrthologousToK10L2.txt", sep="\t", row.names=FALSE, col.names=TRUE, quote=FALSE)