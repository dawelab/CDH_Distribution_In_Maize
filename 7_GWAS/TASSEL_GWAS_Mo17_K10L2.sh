...
#SBATCH -J TASSEL_GWAS_B73v3_K10L2
#SBATCH --output TASSEL_GWAS_B73v3_K10L2.out
#SBATCH --mem=900GB
...
REF="/scratch/mjb51923/Ab10_Global_Survey/out/AlignGBS_HiFiAb10Corrected_v2/B73_RefGen_v3_NoChr10Shared_K10L2.fa"
NAME="GWAS_B73v3_K10L2"
