...
NAME="GWAS_Mo17_Ab10.Ab10.landrace.filt.imputed"
...
plink --bfile $DIR/$NAME --logistic --beta --allow-extra-chr -covar $DIR/Ab10_PCA.eigenvec --pheno $DIR/Ab10Call_ForPLINK.txt --1 --allow-no-sex --out Ab10_AB10_PCA_results
