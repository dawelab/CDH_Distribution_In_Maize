...
#SBATCH -J Plink_GWAS_K10L2
#SBATCH --output Plink_GWAS_K10L2.out
#SBATCH --mem=50GB
#SBATCH --time=2:00:00
#SBATCH	--nodes=1
#SBATCH	--ntasks=1
...
NAME="GWAS_Mo17_K10L2.chr.landrace.filt"
...
bcftools concat -o $DIR/GWAS_Mo17_K10L2.chr.landrace.filt.imputed.vcf.gz $DIR/GWAS_Mo17_K10L2.chr.landrace.filt_chr*.imputed.vcf.gz

NAME="GWAS_Mo17_K10L2.chr.landrace.filt.imputed"
...
plink --bfile $DIR/$NAME --pca 10 'header' 'tabs' 'var-wts' --out $DIR/K10L2_PCA

#This performs a logistic GWAS for K10L2. --1 indicates my phenotype are coded as 0 and 1
plink --bfile $DIR/$NAME --logistic --beta -covar $DIR/K10L2_PCA.eigenvec --pheno $DIR/K10L2Call_ForPLINK.txt --1 --allow-no-sex --out K10L2_results_PCA
