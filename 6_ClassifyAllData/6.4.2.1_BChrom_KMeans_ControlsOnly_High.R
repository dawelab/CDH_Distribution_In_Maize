...
row_colors <- c('B Short Arm' = "lightpink", 'B Centromere' = "darkorange3", 'Proximal Heterochromatin' = "aliceblue", 'Proximal euchromatin 1' = "palevioletred", 'Proximal euchromatin 2' = "hotpink", 'distal heterochromatin 1' =  "powderblue", "distal heterochromatin 2" = "lightskyblue", "distal heterochromatin 3" = "deepskyblue3", "distal heterochromatin 4" = "dodgerblue4", "distal euchromatin" = "deeppink4" )
...
write.csv(Final, file = "BChromHigh_Kmeans_Groups_Final.csv", row.names = FALSE, quote = FALSE)
...
png("PropCorrect_BChrom_High.png")
