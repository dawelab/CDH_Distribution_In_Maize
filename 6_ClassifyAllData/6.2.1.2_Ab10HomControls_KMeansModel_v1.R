...
for(j in 1:100) {
  ...
  #This selects only homozygous Ab10 lines
  ...
  for(i in 1:3) {
    ...
    write.table(heat_data_samp, file = paste("Ab10_Model/Controls_Ab10N10Model/HomozygousControls/SubSamples/heat_data_samp", i, "txt", sep ="."), row.names = FALSE, quote = FALSE, sep = "\t")
  ...
  for(k in 1:3) {
    ...
    heat_data_samp <- read.table(paste("Ab10_Model/Controls_Ab10N10Model/HomozygousControls/SubSamples/heat_data_samp", i, "txt", sep ="."), header = TRUE,  sep = "\t", check.names=FALSE)
    ...
    pdf(file = paste("Ab10_Model/Controls_Ab10N10Model/HomozygousControls/Images/Ab10Hom_Controls_HeatMap", j, k,"pdf", sep="."))
  ...
  fwrite(KMeans_Groups_All_v2[,c(1,4)], file = paste("Ab10_Model/Experimental_Ab10N10Model/HomozygousControls/KmeansGroups_Files/Kmeans_Exp_Groups_Temp.", j, ".table", sep=""))
}
