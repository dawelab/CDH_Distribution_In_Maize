...
DF_EXTRA_2 <- subset(DF_EXTRA, (Data_Source == "Dawe_Lab_1" | Data_Source == "Dawe_Lab_2") & (Ab10_Status == "K10L2" | Ab10_Status == "N10") & Name != "W23_AB10-I.11.DC1" & Name != "W23_AB10-I.13.DC1" & Name != "W23_AB10-II.36.DC1" & Name != "W23_N10.14.DC1" & Name != "B73_K10L2.8.DC2")
...
columntype_colors <- c("K10L2" = "brown", "N10" ="grey80", "Unknown" = "white")
...
for(j in 1:5) {
  ...
  for(i in 1:q) {
    ...
    write.table(heat_data_samp, file = paste("K10L2_Model/Experimental_K10L2N10Model/SubSamples/K10L2N10_Exp_heat_data_samp_MixedControls", IT, i, "txt", sep ="."), row.names = FALSE, quote = FALSE, sep = "\t")
  ...
  while(k <= q) {
    print(k)
    heat_data_samp <- read.table(paste("K10L2_Model/Experimental_K10L2N10Model/SubSamples/K10L2N10_Exp_heat_data_samp_MixedControls", IT, k, "txt", sep ="."), header = TRUE,  sep = "\t", check.names=FALSE)
    ...
    group = kmeans(t(heat_data_samp[c(4:15),]), centers = 2)$cluster
    ...
    if(sum(KMeans_Groups_4$Correct) == length(KMeans_Groups_4$Correct)) {
      ...
      pdf(file = paste("K10L2_Model/Experimental_K10L2N10Model/Images/K10L2N10_HeatMap_MixedControls", IT, j, k,"pdf", sep="."))
...
fwrite(Final, file = paste("K10L2_Model/Experimental_K10L2N10Model/KmeansGroups_Files/K10L2_Kmeans_Exp_Groups_MixedControls", IT, "table", sep="."))

fwrite(QC_Controls, file = paste("K10L2_Model/Experimental_K10L2N10Model/QualityControl/K10L2_QualityControl_KMeansGroupingControls_MixedControls", IT, "table", sep="."))
