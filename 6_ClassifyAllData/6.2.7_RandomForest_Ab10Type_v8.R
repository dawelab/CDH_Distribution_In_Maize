...
MERGE_Ab10Hap_RPM_FILT_2_FIX <- vroom::vroom("/Users/user/University_of_Georgia/Dawe_Lab_Documents/Ab10_Global_Survey/R_Sessions/Ab10Model/BWAaln_All_v_Ab10HIFIBChrom.Ab10.RPM.RNMean.table")
...
POS <- vroom::vroom("/Users/user/University_of_Georgia/Dawe_Lab_Documents/Ab10_Global_Survey/R_Sessions/SGE_Distribution_Paper/Kmeans_Exp_Groups_MixedControls_All.csv")
