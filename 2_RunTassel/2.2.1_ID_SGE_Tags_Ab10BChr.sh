...
bedtools intersect -wa -a BWAaln_AllData_v5_v_B73-Ab10_BChrom.s.bed -b Ab10.bed > Ab10_TagID.bed
bedtools intersect -wa -a BWAaln_AllData_v5_v_B73-Ab10_BChrom.s.bed -b BChrom.bed > BChrom_TagID.bed
...
awk '{print $1}' Tassel_TagTaxaDist_AllData_v5_v_B73-Ab10_BChrom.txt > Tassel_TagTaxaDist_AllData_v5_v_B73-Ab10_BChrom_TagsOnly.txt
